    ...
    <section className="relative py-20 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[400px]">
          ...
          {/* Linker Vlak - Het Probleem (Donkere 'glas' look) */}
          ...
          {/* Rechter Vlak - De Oplossing (Blauwe 'glow' look) */}
          ...
          {/* Centraal Element - Logo (absoluut gepositioneerd op de scheidslijn tussen de vlakken, achter tekst maar voor achtergrond) */}
